    ...
    <div id="left-panel">
      ...
      <div class="screen-container">
        <div class="screen">
          ...
          <div id="main-screen">
            <img :src="obj.pokemon.sprites.front_default" alt="Image" />
          </div>
      ...
      <div class="buttons-container">
        ...
        <div class="nav-buttons-container">
          ...
          <div class="green-screen">
            <span id="name-screen">{{ obj.pokemon.name }}</span>
          </div>
    ...
    <div id="right-panel">
      ...
      <div class="top-screen-container">
        <div id="about-screen" class="right-panel-screen">
          Height: {{ obj.pokemon.height }}inch Weight:
          {{ obj.pokemon.weight }}kg
        </div>
      </div>
      <!-- Blue Buttons -->
      ...
      <div class="bottom-screens-container">
        <div id="type-screen" class="right-panel-screen">
          {{ obj.pokemon.types[0].type.name }}
        </div>
        <div id="id-screen" class="right-panel-screen">
          {{
            obj.pokemon.types[1]
              ? obj.pokemon.types[1].type.name
              : `#${obj.pokemon.order}`
          }}
        </div>
      </div>
...
#main-screen {
  ...
  border-radius: 5%;
  background-image: url(https://assets.pokemon.pokemon.com/assets/cms2/img/pokedex/full/001.png);
